package com.dmytrobilash.karnaughmap_java.model.PoS;


public class FourVariablesPoS {
        ...
        public FourVariablesPoS(int[] val) {
            int count = 0;
            for (int i = 0; i < 4; i++) {
                for (int j = 0; j < 4; j++) {
                    if (val[count] == 2) {
        ...
        private void check4() {
            ...
            //top_left
            if (A[0][0] == 0 && A[1][0] == 0 && A[0][1] == 0 && A[1][1] == 0 &&
            ...
            //top_right
            if (A[0][2] == 0 && A[0][3] == 0 && A[1][2] == 0 && A[1][3] == 0 &&
            ...
            //bottom_left
            if (A[2][0] == 0 && A[3][0] == 0 && A[2][1] == 0 && A[3][1] == 0 &&
            ...
            //bottom_right
            if (A[2][2] == 0 && A[2][3] == 0 && A[3][2] == 0 && A[3][3] == 0 &&
            ...
            //center-top
            if (A[0][1] == 0 && A[0][2] == 0 && A[1][1] == 0 && A[1][2] == 0 &&
            ...
            //center-bottom
            if (A[2][1] == 0 && A[2][2] == 0 && A[3][1] == 0 && A[3][2] == 0 &&
            ...
            //center-left
            if (A[1][0] == 0 && A[2][0] == 0 && A[1][1] == 0 && A[2][1] == 0 &&
            ...
            //center-right
            if (A[1][2] == 0 && A[2][2] == 0 && A[1][3] == 0 && A[2][3] == 0 &&
            ...
            //corners
            if (A[0][0] == 0 && A[0][3] == 0 && A[3][0] == 0 && A[3][3] == 0 &&
            ...
            //left-right-top
            if (A[0][0] == 0 && A[1][0] == 0 && A[0][3] == 0 && A[1][3] == 0 &&
            ...
            //left-right-bottom
            if (A[2][0] == 0 && A[3][0] == 0 && A[2][3] == 0 && A[3][3] == 0 &&
            ...
            //left-right-center
            if (A[1][0] == 0 && A[2][0] == 0 && A[1][3] == 0 && A[2][3] == 0 &&
            ...
            //top-bottom-left
            if (A[0][0] == 0 && A[0][1] == 0 && A[3][0] == 0 && A[3][1] == 0 &&
            ...
            //top-bottom-right
            if (A[0][2] == 0 && A[0][3] == 0 && A[3][2] == 0 && A[3][3] == 0 &&
            ...
            //top-bottom-center
            if (A[0][1] == 0 && A[0][2] == 0 && A[3][1] == 0 && A[3][2] == 0 &&
        ...
        private void check2() {
            ...
            // top (left-right)
            if (A[0][0] == 0 && A[0][1] == 0 && (checked[0][0] == 0 || checked[0][1] == 0)) {
                checked[0][0] = 1;
                checked[0][1] = 1;
                if (output.equals("")) {
                    output += "(A+B+C)";
            ...
            if (A[0][1] == 0 && A[0][2] == 0 && (checked[0][1] == 0 || checked[0][2] == 0)) {
                checked[0][1] = 1;
                checked[0][2] = 1;
                if (output.equals("")) {
                    output += "(A+B+D')";
            ...
            if (A[0][2] == 0 && A[0][3] == 0 && (checked[0][2] == 0 || checked[0][3] == 0)) {
                checked[0][2] = 1;
                checked[0][3] = 1;
                if (output.equals("")) {
                    output += "(A+B+C')";
            ...
            if (A[0][3] == 0 && A[0][0] == 0 && (checked[0][3] == 0 || checked[0][0] == 0)) {
                checked[0][3] = 1;
                checked[0][0] = 1;
                if (output.equals("")) {
                    output += "(A+B+D)";
            ...
            if (A[1][0] == 0 && A[1][1] == 0 && (checked[1][0] == 0 || checked[1][1] == 0)) {
                checked[1][0] = 1;
                checked[1][1] = 1;
                if (output.equals("")) {
                    output += "(A+B'+C)";
            ...
            if (A[1][1] == 0 && A[1][2] == 0 && (checked[1][1] == 0 || checked[1][2] == 0)) {
                checked[1][1] = 1;
                checked[1][2] = 1;
                if (output.equals("")) {
                    output += "(A+B'+D')";
            ...
            if (A[1][2] == 0 && A[1][3] == 0 && (checked[1][2] == 0 || checked[1][3] == 0)) {
                checked[1][2] = 1;
                checked[1][3] = 1;
                if (output.equals("")) {
                    output += "(A+B'C')";
            ...
            if (A[1][3] == 0 && A[1][0] == 0 && (checked[1][3] == 0 || checked[1][0] == 0)) {
                checked[1][3] = 1;
                checked[1][0] = 1;
                if (output.equals("")) {
                    output += "(A+B'+D)";
            ...
            if (A[2][0] == 0 && A[2][1] == 0 && (checked[2][0] == 0 || checked[2][1] == 0)) {
                checked[2][0] = 1;
                checked[2][1] = 1;
                if (output.equals("")) {
                    output += "(A'+B'+C)";
            ...
            if (A[2][1] == 0 && A[2][2] == 0 && (checked[2][1] == 0 || checked[2][2] == 0)) {
                checked[2][1] = 1;
                checked[2][2] = 1;
                if (output.equals("")) {
                    output += "(A'+B'+D')";
            ...
            if (A[2][2] == 0 && A[2][3] == 0 && (checked[2][2] == 0 || checked[2][3] == 0)) {
                checked[2][2] = 1;
                checked[2][3] = 1;
                if (output.equals("")) {
                    output += "(A'+B'+C')";
            ...
            if (A[2][3] == 0 && A[2][0] == 0 && (checked[2][3] == 0 || checked[2][0] == 0)) {
                checked[2][3] = 1;
                checked[2][0] = 1;
                if (output.equals("")) {
                    output += "(A'+B'+D)";
            ...
            //bot (left-right)
            if (A[3][0] == 0 && A[3][1] == 0 && (checked[3][0] == 0 || checked[3][1] == 0)) {
                checked[3][0] = 1;
                checked[3][1] = 1;
                if (output.equals("")) {
                    output += "(A'+B+C)";
            ...
            if (A[3][1] == 0 && A[3][2] == 0 && (checked[3][1] == 0 || checked[3][2] == 0)) {
                checked[3][1] = 1;
                checked[3][2] = 1;
                if (output.equals("")) {
                    output += "(A+B+D')";
            ...
            if (A[3][2] == 0 && A[3][3] == 0 && (checked[3][2] == 0 || checked[3][3] == 0)) {
                checked[3][2] = 1;
                checked[3][3] = 1;
                if (output.equals("")) {
                    output += "(A'+B+C')";
            ...
            if (A[3][3] == 0 && A[3][0] == 0 && (checked[3][3] == 0 || checked[3][0] == 0)) {
                checked[3][0] = 1;
                checked[3][3] = 1;
                if (output.equals("")) {
                    output += "(A'+B+D)";
            ...
            //left (top-bot)
            if (A[0][0] == 0 && A[1][0] == 0 && (checked[0][0] == 0 || checked[1][0] == 0)) {
                checked[0][0] = 1;
                checked[1][0] = 1;
                if (output.equals("")) {
                    output += "(A+C+D)";
            ...
            if (A[1][0] == 0 && A[2][0] == 0 && (checked[1][0] == 0 || checked[2][0] == 0)) {
                checked[1][0] = 1;
                checked[2][0] = 1;
                if (output.equals("")) {
                    output += "(B'+C+D)";
            ...
            if (A[2][0] == 0 && A[3][0] == 0 && (checked[2][0] == 0 || checked[3][0] == 0)) {
                checked[2][0] = 1;
                checked[3][0] = 1;
                if (output.equals("")) {
                    output += "(A'+C+D)";
            ...
            if (A[3][0] == 0 && A[0][0] == 0 && (checked[3][0] == 0 || checked[0][0] == 0)) {
                checked[3][0] = 1;
                checked[0][0] = 1;
                if (output.equals("")) {
                    output += "(B+C+D)";
            ...
            //left_center (top-bot)
            if (A[0][1] == 0 && A[1][1] == 0 && (checked[0][1] == 0 || checked[1][1] == 0)) {
                checked[0][1] = 1;
                checked[1][1] = 1;
                if (output.equals("")) {
                    output += "(A+C+D')";
            ...
            if (A[1][1] == 0 && A[2][1] == 0 && (checked[1][1] == 0 || checked[2][1] == 0)) {
                checked[1][1] = 1;
                checked[2][1] = 1;
                if (output.equals("")) {
                    output += "(A+B+C)";
            ...
            if (A[2][1] == 0 && A[3][1] == 0 && (checked[2][1] == 0 || checked[3][1] == 0)) {
                checked[2][1] = 1;
                checked[3][1] = 1;
                if (output.equals("")) {
                    output += "(B'+C+D')";
            ...
            if (A[3][1] == 0 && A[0][1] == 0 && (checked[3][1] == 0 || checked[0][1] == 0)) {
                checked[3][1] = 1;
                checked[0][1] = 1;
                if (output.equals("")) {
                    output += "(B+C+D')";
            ...
            if (A[0][2] == 0 && A[1][2] == 0 && (checked[0][2] == 0 || checked[1][2] == 0)) {
                checked[0][2] = 1;
                checked[1][2] = 1;
                if (output.equals("")) {
                    output += "(A+C'+D')";
            ...
            if (A[1][2] == 0 && A[2][2] == 0 && (checked[1][2] == 0 || checked[2][2] == 0)) {
                checked[1][2] = 1;
                checked[2][2] = 1;
                if (output.equals("")) {
                    output += "(B'+C'+D')";
            ...
            if (A[2][2] == 0 && A[3][2] == 0 && (checked[2][2] == 0 || checked[3][2] == 0)) {
                checked[2][2] = 1;
                checked[3][2] = 1;
                if (output.equals("")) {
                    output += "(A'+C'+D')";
            ...
            if (A[3][2] == 0 && A[0][2] == 0 && (checked[3][2] == 0 || checked[0][2] == 0)) {
                checked[3][2] = 1;
                checked[0][2] = 1;
                if (output.equals("")) {
                    output += "(B+C'+D')";
            ...
            //right (top-bot)
            if (A[0][3] == 0 && A[1][3] == 0 && (checked[0][3] == 0 || checked[1][3] == 0)) {
                checked[0][3] = 1;
                checked[1][3] = 1;
                if (output.equals("")) {
                    output += "(A+C'+D)";
            ...
            if (A[1][3] == 0 && A[2][3] == 0 && (checked[1][3] == 0 || checked[2][3] == 0)) {
                checked[1][3] = 1;
                checked[2][3] = 1;
                if (output.equals("")) {
                    output += "(B'+C+D)";
            ...
            if (A[2][3] == 0 && A[3][3] == 0 && (checked[2][3] == 0 || checked[3][3] == 0)) {
                checked[2][3] = 1;
                checked[3][3] = 1;
                if (output.equals("")) {
                    output += "(A'+C'+D)";
            ...
            if (A[3][3] == 0 && A[0][3] == 0 && (checked[3][3] == 0 || checked[0][3] == 0)) {
                checked[3][3] = 1;
                checked[0][3] = 1;
                if (output.equals("")) {
                    output += "(B+C'+D)";
        ...
        private void nogrouping() {
            ...
            if (A[2][0] == 0 && checked[2][0] == 0) {
                if (output.equals("")) {
                    output += "(A'+B'+C+D)";
                } else output += "*(A'+B'+C+D)";
                groups += "[8]";
            }
            if (A[2][1] == 0 && checked[2][1] == 0) {
                if (output.equals("")) {
                    output += "(A'+B'+C+D')";
                } else output += "*(A'+B'+C+D')";
                groups += "[9]";
            }
            if (A[2][2] == 0 && checked[2][2] == 0) {
                if (output.equals("")) {
                    output += "(A'+B'+C'+D')";
                } else output += "*(A'+B'+C'+D')";
                groups += "[10]";
            }
            if (A[2][3] == 0 && checked[2][3] == 0) {
                if (output.equals("")) {
                    output += "(A'+B'+C'+D)";
                } else output += "*(A'+B'+C'+D)";
                groups += "[11]";
            }
            if (A[3][0] == 0 && checked[3][0] == 0) {
                if (output.equals("")) {
                    output += "(A'+B+C+D)";
                } else output += "*(A'+B+C+D)'";
                groups += "[12]";
            }
            if (A[3][1] == 0 && checked[3][1] == 0) {
                if (output.equals("")) {
                    output += "(A'+B+C+D')";
                } else output += "*(A'+B+C+D')";
                groups += "[13]";
            }
            if (A[3][2] == 0 && checked[3][2] == 0) {
                if (output.equals("")) {
                    output += "(A'+B+C'+D')";
                } else output += "*(A'+B+C'+D')";
                groups += "[14]";
            }
            if (A[3][3] == 0 && checked[3][3] == 0) {
                if (output.equals("")) {
                    output += "(A'+B+C'+D)";
                } else output += "*(A'+B+C'+D)";
                groups += "[15]";
